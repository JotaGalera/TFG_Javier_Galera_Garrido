        ...
        for (const path of args) {
            try {
                ...
                for (const depRootDeps of perDepRootResults) {
                    const res = yield promiseOrCleanup(monitor_1.monitor(path, meta, depRootDeps), spinner.clear(postingMonitorSpinnerLabel));
                    ...
                    const subProjectName = (inspectResult.depRoots)
                        ...
                        : undefined;
                    const monOutput = formatMonitorOutput(packageManager, res, manageUrl, options, subProjectName);
...
function formatMonitorOutput(packageManager, res, manageUrl, options, subProjectName) {
