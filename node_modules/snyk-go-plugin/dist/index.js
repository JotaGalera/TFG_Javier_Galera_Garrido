...
function recursivelyBuildPkgTree(graph, node, lockedVersions, projectRootPath, counts) {
    ...
    children.forEach((depName) => {
        ...
        const child = recursivelyBuildPkgTree(graph, dep, lockedVersions, projectRootPath, sumCounts(counts, pkg._counts));
